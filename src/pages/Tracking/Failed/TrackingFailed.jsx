              ...
              <Col span={24}>
                <div className="flex flex-col">
                  <div className="bg-white p-5 rounded-lg">
                    <Row>
                      <Col span={24}>
                        <div className="text-[24px] text-main inline-block">Tracking Cancel</div>
                        <br />
                        <span className="text-[15px] inline-block mt-5">Tracking Cancel data</span>
                      </Col>
                    </Row>
                  </div>
                      ...
                      <Col span={24}>
                        <div className="flex flex-col">
                          <Row justify="space-between" align="middle" className="mb-4">
                            <Col>
                              <span className="text-[24px] inline-block">Cancel</span>
                            </Col>
