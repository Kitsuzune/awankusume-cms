            ...
            <div key={i}>
                <Row gutter={16}>
                    <Col span={24}>
                        ...
                        >
                            <Input name={`peralatanKantor`} defaultValue={officeEquipment?.peralatanKantor} disabled />
                        </Form.Item>
                    </Col>
                </Row>
            </div>
            ...
            <Row gutter={16}>
                <Col span={24}>
                    ...
                    >
                        ...
                        />
                        <Button className='mt-2 w-full' onClick={() => {
                            window.open(`${import.meta.env.REACT_APP_API_URL_CSM}/public/showcase/${dataView?.businessOrder?.npwp}`, '_blank');
                        }}>
                            <DownSquareTwoTone />
                            Download
                        </Button>
            ...
            <Row gutter={16}>
                <Col span={24}>
                    ...
                    >
                        ...
                        />
                        <Button className='mt-2 w-full' onClick={() => {
                            window.open(`${import.meta.env.REACT_APP_API_URL_CSM}/public/showcase/${dataView?.businessOrder?.rukoImage}`, '_blank');
                        }}>
                            <DownSquareTwoTone />
                            Download
                        </Button>
